...
__attribute__((section(".extFlashMem"))) static const uint16_t unicode_list_9[] = {
...
#else
__attribute__((section(".extFlashMem"))) static lv_font_fmt_txt_dsc_t font_dsc = {
#endif
...
#if LVGL_VERSION_MAJOR >= 8
__attribute__((section(".extFlashMem"))) const lv_font_t lv_font_dejavu_16_persian_hebrew = {
#else
__attribute__((section(".extFlashMem"))) lv_font_t lv_font_dejavu_16_persian_hebrew = {
#endif
