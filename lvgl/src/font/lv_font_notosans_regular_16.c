 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --font NotoSans-Regular.ttf -r 0x000-0x007F --size 16 --format lvgl --bpp 4 --no-compress -o ./output/lv_font_notosans_regular_16.c
 ******************************************************************************/
...
#ifndef LV_FONT_NOTOSANS_REGULAR_16
#define LV_FONT_NOTOSANS_REGULAR_16 1
#endif

#if LV_FONT_NOTOSANS_REGULAR_16
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_notosans_regular_16 = {
#else
lv_font_t lv_font_notosans_regular_16 = {
#endif
...
#endif /*#if LV_FONT_NOTOSANS_REGULAR_16*/
